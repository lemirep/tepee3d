 ...
 Component.prototype.createOperations = function()
 {
	 ...
	 if (installer.value("os") ==  "x11") {
            component.addOperation("CreateDesktopEntry", "Tepee3D.desktop", "Type=Application", "Name=Tepee3D", "Exec=@TargetDir@/Tepee3DEngine.sh", "Terminal=true", "Icon=@TargetDir@/qml/Resources/Pictures/tepee3d_icon.png");
