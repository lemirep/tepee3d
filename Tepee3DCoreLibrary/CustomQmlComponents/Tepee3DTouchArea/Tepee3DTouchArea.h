...
#ifndef TEPEE3DTOUCHAREA_H
#define TEPEE3DTOUCHAREA_H
...
class QQuickTouchPoint : public QObject
{
    Q_OBJECT
...
class QQuickMultiPointTouchArea : public QQuickItem
{
    Q_OBJECT
